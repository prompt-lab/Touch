    ...
    def __init__(self, args, mode='train'):
        ...
        if mode == 'train':
            if args.cls_mode == 'rough':
                self.txt = 'tactile_datasets/train/TAG/train_rough.txt'
            elif args.cls_mode == 'material' or args.cls_mode == 'hard':
                self.txt = 'tactile_datasets/train/TAG/train.txt'
        else:
            if args.cls_mode == 'rough':
                self.txt = 'tactile_datasets/train/TAG/test_rough.txt'
            elif args.cls_mode == 'material' or args.cls_mode == 'hard':
                self.txt = 'tactile_datasets/train/TAG/test.txt'
